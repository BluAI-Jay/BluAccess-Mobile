...
export default function SalesmanLogin({ navigation }) {
  ...
  const [otp, setOtp] = useState('256358');
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.brandWrap}>
          ...
          <Text style={styles.brandTitle}>Welcome to EAMMS for Sales</Text>
          <Text style={styles.brandSubtitle}>Employee Attendance Management and Monitoring System</Text>
        </View>

        <View style={styles.card}>
          <View style={styles.formArea}>
            <Text style={styles.heading}>Salesman Login</Text>
            <Text style={styles.subheading}>All fields are required</Text>

            {/* <Text style={styles.errorText}>Invalid username, password, or company code</Text> */}
            ...
            <TouchableOpacity style={styles.primaryButton} onPress={() => login('salesman')}>
              <Text style={styles.primaryText}>Login as Salesman</Text>
            </TouchableOpacity>

            <View style={styles.orRow}><View style={styles.orLine} /><Text style={styles.orText}>OR</Text><View style={styles.orLine} /></View>

            <TouchableOpacity style={styles.primaryButton} onPress={() => navigation.replace('EmployeeLogin')}>
              <Text style={styles.primaryText}>Employee Login</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
